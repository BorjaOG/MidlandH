...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div style="margin-top:8%" class="carousel-container text-center">
  <div id="carouselExampleSlidesOnly" class="carousel slide mx-auto" data-bs-interval="3500" data-bs-ride="carousel">
    ...
    <h4 style=" margin-top:5%; margin-bottom:5%; margin-right:25%; margin-left:25%; font-family: italic; text-align: center;">
        Texto de la card. Puedes agregar aquí una descripción o más detalles sobre el contenido que quieres mostrar en la card.
    </h4>
    <div class="row g-0 ">
      <div class="col-md-8">
      ...
      <div class="col-md-4">
        ...
        <h5 style=" margin-top:5%; margin-bottom:5%; margin-right:20%; margin-left:20%; font-family: italic; text-align: center;" class="card-text">
            Texto de la card. Puedes agregar aquí una descripción o más detalles sobre el contenido que quieres mostrar en la card.    
        </h5>
